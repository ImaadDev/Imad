  ...
  const projects = [
    {
      ...
      category: isArabic ? "نظام أعمال" : "Business System",
      year: "2025",
      stack: ["Next.js", "Node.js", "MongoDB"],
      description: isArabic
        ? "نظام تخطيط موارد المؤسسات متعدد الأدوار مع لوحات تحكم للمسؤول، العميل، الموظف، والشريك. سير عمل آلي للمدفوعات والتحقق، مما زاد الكفاءة بنسبة 35%."
        : "Multi-role ERP with dashboards for Admin, Client, Employee, and Partner. Automated workflows for payments and verification, increasing efficiency by 35%.",
    ...
    },
    {
      ...
      category: isArabic ? "تحليلات / SaaS" : "Analytics / SaaS",
      year: "2024",
      stack: ["React.js", "Next.js", "MongoDB"],
      description: isArabic
        ? "لوحة تحكم تحليلية ببيانات في الوقت الفعلي، تقارير مخصصة، وتحكم في الوصول حسب الدور (RBAC). تحسين استجابة النظام بنسبة 30% باستخدام تقسيم الكود."
        : "Analytics dashboard with real-time data, custom reporting, and RBAC. Improved system responsiveness by 30% using code splitting.",
    ...
    },
    {
      ...
      category: isArabic ? "نظام إدارة محتوى / موقع" : "CMS / Website",
      year: "2024",
      stack: ["Next.js", "Sanity", "Tailwind"],
      description: isArabic
        ? "موقع ويب حديث متحرك مع تكامل Sanity CMS. يتميز بإدارة محتوى ديناميكية ونقاط نهاية API مخصصة لتسليم البيانات بسرعة."
        : "Modern animated website with Sanity CMS integration. Features dynamic content management and custom API endpoints for fast data delivery.",
